#include "../../Gameplay/Monitor.as"

class MainLevel : plAngelScriptClass
{
        ...
        if (msg.Message == "MoveA" || msg.Message == "MoveB")
        {
            ...
            if (GetWorld().TryGetObjectWithGlobalKey("Obj", @obj))
            {
                ...
                if (obj.TryGetComponentOfBaseType(@move))
                {
                    ...
                    {
                        move.SetTargetPosition(plVec3(10, -1, 1.5));
                    }
                    else
                    {
                        move.SetTargetPosition(plVec3(10, 3, 1.5));
                    }
                }
            }
        }
